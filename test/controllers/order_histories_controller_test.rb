...
class OrderHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_history" do
    assert_difference('OrderHistory.count') do
      post order_histories_url, params: { order_history: { price: @order_history.price, status: @order_history.status, title: @order_history.title } }
    end
  ...
  test "should update order_history" do
    patch order_history_url(@order_history), params: { order_history: { price: @order_history.price, status: @order_history.status, title: @order_history.title } }
